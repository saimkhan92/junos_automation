...
with Device(host='10.10.10.11', user='root', password='Embe1mpls', mode='telnet', port='7026', gather_facts=True) as dev:
        ...
        with Config(dev, mode='private') as cu:  
                #cu.load('load factory-default', format='set')
                #cu.load('set system root-authentication encrypted-password "$6$lQnPO$pGNh7LZJK/ZzJwsdGipgM3Mu3DjTsyQcT/BLUHCa2iM6R1lH6WweK58BakPoYoxorLfo29oTKuOFGoje0i0pc0"', format='set')   #Embe1mpls
                try:
